...
from trainer.trainer import MaximumLikelihoodEstimationEngine
from trainer.rl_trainer import MinimumRiskTrainingEngine
...
def main(config, model_weight=None, opt_weight=None):
    ...
    mle_trainer = SingleTrainer(MaximumLikelihoodEstimationEngine, config, device)
    mle_trainer.train(
        model,
        crit,
        optimizer,
        ...
        src_vocab=loader.src_vocab,
        tgt_vocab=loader.tgt_vocab,
